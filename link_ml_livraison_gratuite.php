...
$link_livraison_gratuite = 'https://www.nespresso.com/fr/fr/programme#!/livraison-offerte';

if ( $par_domaine == "VM" ) {

	if ($par_src_index == 'lp') {
		//pointe sur l'index index
		header('Location: '. $link_livraison_gratuite .'?' . $par_operation_client_tracking);
	} else {
