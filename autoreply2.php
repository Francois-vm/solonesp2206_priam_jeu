							...
							<tbody>
                                ...
                                <tr>
                                    <td align="center" valign="middle">
                                        <a href="link_autoresp2_visu.php"
								...
								<tr>
									<td align="center">
										<a href="link_autoresp2_visu.php" target="_blank"><img src="visuals/ml_bandeau.jpg" width="700" height="auto" class="resize320" style="display:block; border:0; width:100%; max-width:700px; height:auto;" alt="" /></a>
									</td>
								</tr>
                                <tr>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td align="center" class="show_mobile">
                                                    <a href="link_autoresp2_pic1.php" target="_blank" style="border:0;"><img src="visuals/ml_avantages_1.jpg" alt="Un caf&eacute; de qualit&eacute; durable" width="334.1" height="auto" style="display: block;" class="show_mobile" /></a>
                                                </td>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="show_mobile" align="center">
                                                    <a href="link_autoresp2_pic2.php" target="_blank" style="border:0;"><img src="visuals/ml_avantages_2.jpg" alt="L'accompagnent des caf&eacute;iculteurs" width="334.1" height="auto" style="display: block;" class="show_mobile" /></a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                ...
                                <td>
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                        <tbody>
                                            <tr>
                                                <td class="show_mobile" align="center">
                                                    <a href="link_autoresp2_pic3.php" target="_blank" style="border:0;"><img src="visuals/ml_avantages_3.jpg" alt="Notre choix de l'aluminium" width="334.1" height="auto" style="display: block;" class="show_mobile" /></a>
                                                </td>
                                                <td class="show_mobile" align="center" style="font-size: 16px; line-height: 22px; font-family: Nespresso Lucas Light, Arial, Helvetica, sans-serif; color:#000001; padding : 0 15px;" class="f22">
                                                    <span align="center" style="font-size: 22px; font-family: Nespresso Lucas XtraBd, Arial, Helvetica, sans-serif; color: #000000 " class="f22">
                                                        NOTRE CHOIX<br />
					...
					<table cellspacing="0" cellpadding="0" border="0" style="width:100%; Max-Width:700px;" class="general">
						...
						<tr>
							<td align="center" style="padding-left:20px; padding-right:20px;line-height: 18px; font-size: 10px;font-family:Nespresso Lucas, Arial, Helvetica, sans-serif;color:#1e2326">
                                ...
                                Colissimo, en Point Relais (hors livraison avec Chronopost, <br class="dn"/> Chronorelais, Coursier 24h, et Nespresso Your Time) pour tout achat d'accessoires, de machines ou d&egrave;s 50 capsules <br class="dn"/>command&eacute;es de la gamme Original ou d&egrave;s 30 capsules de la gamme Vertuo command&eacute;es sur le site internet <a href="link_autoresp2_mention_site.php" style="color: #1e2326; text-decoration: none" target="_blank">Nespresso.com</a>, <br class="dn"/>depuis l'application mobile Nespresso, ou par t&eacute;l&eacute;phone au 0 800 55 52 53 (appel et service gratuits, disponibles du lundi au <br class="dn"/>samedi de  8h &agrave; 20h, hors 1<sup>er</sup> mai et jours f&eacute;ri&eacute;s).
								<br /><br />
                                Vous recevez ce message suite à votre demande de participation au jeu concours Nespresso<br />Vous pouvez vous désinscrire à tout moment en utilisant le lien de désabonnement intégré dans la newsletter initiale.
							</td>
						</tr>
						<tr>
							<td height="20" style="height:20px; line-height:20px; font-size:1px;">&nbsp;</td>
