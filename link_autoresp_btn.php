...
$link_btn = 'https://www.nespresso.com/fr/fr/';

if ( $par_domaine == "VM" ) {

	if ($par_src_index == 'lp') {
		//pointe sur l'index index
		header('Location: '. $link_btn .'?' . $par_operation_client_tracking2); // qualif5 récup dans le mailit la valeur de qualif5 qui contient le code promo
	} else {
