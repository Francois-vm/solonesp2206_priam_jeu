...
$link_degustation_offerte = 'https://www.nespresso.com/fr/fr/programme#!/degustation-offerte';

if ( $par_domaine == "VM" ) {

	if ($par_src_index == 'lp') {
		//pointe sur l'index index
		header('Location: '. $link_degustation_offerte .'?' . $par_operation_client_tracking);
	} else {
