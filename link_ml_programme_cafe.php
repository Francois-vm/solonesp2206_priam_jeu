...
$link_programme_cafe = 'https://www.nespresso.com/fr/fr/secure/login?destination-redirect=/fr/fr/myaccount/standing-orders#/orders/list/';

if ( $par_domaine == "VM" ) {

	if ($par_src_index == 'lp') {
		//pointe sur l'index index
		header('Location: '. $link_programme_cafe .'?' . $par_operation_client_tracking);
	} else {
